...
export declare const setupOrmApp: (models_and_routes: Map<string, any>, mergeOrmMw: Partial<IOrmMwConfig>, mergeRoutesConfig: Partial<IRoutesMergerConfig>, callback: (err: Error, app?: restify.Server | import("http").Server | import("https").Server | import("connect").Server | undefined, orms_out?: IOrmsOut | undefined) => void) => void;
